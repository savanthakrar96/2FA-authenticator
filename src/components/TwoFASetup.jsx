...
const TwoFASetup = ({ onSetupComplete }) => {
  ...
  return ( <div className='bg-white rounded-lg shadow-md w-full max-w-sm mx-auto'>
        <div className='pt-6'>
        ...
        <p className='text-center text-gray-600 text-lg font-light pr-5 pl-5'>Scan the QR code below with your authenticator app</p>
       <div className='p-6'>
